...
router.post("/checkout", isLoggedIn, function (req, res, next) {
  ...
  var stripe = require("stripe")("sk_test_vmru1iNMINJZLWXyPU5fomxW");
...
router.get('/categories/action', function (req, res, next) {
  Product.find({
    "genre": "Action"
  }, function (err, docs) {
    if (err) {
...
router.get('/categories/racing', function (req, res, next) {
  Product.find({
    "genre": "Racing"
  }, function (err, docs) {
    if (err) {
...
router.get('/categories/shooting', function (req, res, next) {
  Product.find({
    "genre": "Shooting"
  }, function (err, docs) {
    if (err) {
...
router.get('/categories/openworld', function (req, res, next) {
  Product.find({
    "genre": "Open World"
  }, function (err, docs) {
    if (err) {
...
router.get('/categories/adventure', function (req, res, next) {
  Product.find({
    "genre": "Adventure"
  }, function (err, docs) {
    if (err) {
